...
namespace House_of_cars.BL
{
    class CLS_CARS
    {
        ...
        public void ADD_CAR(int ID_CAR, char AVAILABILITY_FLAG, string MODEL_NAME, int MODEL_YEAR, int MILEAGE, string CAR_CATEGORY_NAME)
        {
        ...
        public DataTable GET_CAR_ID()
        {
            DAL.Data_access_layer DAL = new DAL.Data_access_layer();
            DataTable dt = new DataTable();
            dt = DAL.SelectData("GET_CAR_ID", null);
            DAL.close();
            return dt;
        }
